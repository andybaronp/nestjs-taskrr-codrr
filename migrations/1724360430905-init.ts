...
export class init1724360430905 implements MigrationInterface {
    name = 'init1724360430905'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."task_status_enum" AS ENUM('CREATED', 'IN_PROGRESS', 'DONE')`);
